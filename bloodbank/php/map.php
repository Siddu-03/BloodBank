...
<head>
  ...
  <link rel="stylesheet" href="css/mapstyle.css" /> <!-- Link to your new CSS file -->
...
<body>
  <div class="page-container">
    <header>
      <div class="title-container">
        ...
        <div class="header-actions">
          <a href="index.php" class="header-link"><i class="fas fa-home"></i> Home</a>
        </div>
      </div>
    </header>
    ...
    <div class="map-controls">
      <button class="map-control-button ripple-effect" id="zoomInBtn">
        <i class="fas fa-plus map-control-icon"></i>
      </button>
      <button class="map-control-button ripple-effect" id="zoomOutBtn">
        <i class="fas fa-minus map-control-icon"></i>
      </button>
      <button class="map-control-button ripple-effect" id="recenterBtn">
  ...
  <script>
    ...
    // Add staggered animation to blood bank list items
    ...
    // Add fadeOut animation to CSS or include it inline
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          entry.target.style.animation = 'slideInFromRight 0.6s ease-out both';
        }
      });
    }, observerOptions);

    // Observe all blood bank items
    document.querySelectorAll('.blood-bank-item').forEach(item => {
